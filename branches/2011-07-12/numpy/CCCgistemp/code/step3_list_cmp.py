...
def iter_subbox_grid(station_records, max_months, first_year, radius):
    ...
    *max_months* is the maximum number of months in any station
    ...
    if NumPy:
        misses = ma.masked_equal( ([MISSING] * max_months), MISSING )
    ...
    for region in regions:
        ...
        for subbox in subboxes:
            ...
            # Combine data.
            if NumPy:
                #NOTE: What is the diff from copying or recreating every loop?
            ...
            #NOTE: Here I write the values back to list. Should change
            # series.anomalize, giss_data.Series, and gio.step3_output(result)
            # to accept arrays.
            if NumPy:
